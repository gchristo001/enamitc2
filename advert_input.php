...
if (isset($_POST['title'])){
    ...
    $sql = "INSERT INTO advert (title, description, slot, image)
              VALUES (:title, :description, :slot, :image)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(array(
        ':title' => $_POST['title'],
...
<section class="banner">
    ...
    <div class="box">
    <form method="post"  id="advert-input" action="advert_input.php" enctype="multipart/form-data">
       <h1>Input Iklan</h1>
         <?php
         ...
         ?>
            ...
            <div class="form-field">
                ...
                <textarea id="description" name="description" class= "input" rows="4" cols="50"></textarea>
  			</div>
            <div class="form-field">
